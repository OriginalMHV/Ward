...
mod tests {
    ...
    fn discover_prefixes_groups_by_first_segment() {
        let repos = vec![
            make_repo("s07411-foo", false),
            make_repo("s07411-bar", false),
            make_repo("s07411-baz", false),
            make_repo("s07252-one", false),
            make_repo("s07252-two", false),
        ];

        let prefixes = discover_prefixes(&repos);
        assert_eq!(prefixes.len(), 2);
        assert_eq!(prefixes[0].prefix, "s07411");
        assert_eq!(prefixes[0].count, 3);
        assert_eq!(prefixes[1].prefix, "s07252");
    ...
    fn discover_prefixes_ignores_archived() {
        let repos = vec![
            make_repo("s07411-foo", false),
            make_repo("s07411-bar", true),
            make_repo("s07411-baz", true),
        ];
    ...
    fn discover_prefixes_filters_singletons() {
        ...
        assert_eq!(prefixes[0].prefix, "s07252");
    }
